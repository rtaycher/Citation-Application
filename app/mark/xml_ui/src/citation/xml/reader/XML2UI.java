...
public class XML2UI implements IXMLUIElements{
	...
	public LabelField getTitle() 
	{
		...
		if ( title != null ) {
			title_field = new LabelField(title, LabelField.USE_ALL_WIDTH | LabelField.USE_ALL_HEIGHT | LabelField.FIELD_HCENTER )
			{
	...
	public Field getNextField()
	{
		...
		if ( fieldType != null && fieldValue != null )
		{
			...
			{
				nextField = createCustomLabelField(fieldValue, LabelField.USE_ALL_WIDTH);
			}
			else if (fieldType.equals(EDIT_FIELD))
			{
				nextField =  new EditField(fieldValue, "", 255, EditField.HIGHLIGHT_FOCUS);
			}
			else if (fieldType.equals(CUSTOMEDIT_FIELD))
			{
				...
				nextField =  new CustomEditField(fieldValue, "", 255, height, EditField.HIGHLIGHT_FOCUS);
			}
