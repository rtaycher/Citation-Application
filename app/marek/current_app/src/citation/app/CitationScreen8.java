    ...
    CitationScreen8(Citation _c) {
        ...
        */
        ...
        /*
                ...
                add(lf);         
        */
        LabelField lf0 = new LabelField("OREGON UNIFORM CITATION: #" + cNumberString, LabelField.ELLIPSIS | LabelField.USE_ALL_WIDTH
                | DrawStyle.HCENTER) {
        ...
        if (!c.isSubmitted()) {
            ...
            btn_submit = new ButtonField("Submit & Print", ButtonField.CONSUME_CLICK);
    ...
    public class ButtonListener8 implements FieldChangeListener {
        ...
        public void fieldChanged(Field field, int context) {
            ...
            if (btn.getLabel().toString() == "Prev") {
                ...
                c.setReadOnly(true);
            } else if (btn.getLabel().toString() == "Submit & Print") {
                CitationOutput c_out = new CitationOutput();
