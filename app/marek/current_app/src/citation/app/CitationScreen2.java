...
/*
        ...
        add(lbl);
*/
      LabelField lf2 = new LabelField("************** DEFENDENT ***************", LabelField.ELLIPSIS | LabelField.USE_ALL_WIDTH | DrawStyle.HCENTER)
        {
            protected void paintBackground(net.rim.device.api.ui.Graphics g) 
            { 
                g.clear(); 
        ...
        // ObjectChoiceField
        String choicestrs7[] = {"Golden","Brown","Grey/Blue","Green", "Blue", "Black", "Brown","Red"};
    ...
    private void storeUIFieldsToCitation()
    {
        ...
        //c.Person.setElement(CPerson.FIRST, CPerson.over(field_first.getText(),"First"));
        // c.Person.setElement(CPerson.MIDDLE, CPerson.over(field_middle.getText(),"Middle"));
        //c.Person.setElement(CPerson.LAST, CPerson.over(field_last.getText(),"Last"));  
        ...
        //c.Person.setElement(CPerson.ADDRESS, CPerson.over(field_address.getText(),"Address"));
        ...
        //c.Person.setElement(CPerson.OBSERVATIONS, CPerson.over(field_observations.getText(),"Observations"));
