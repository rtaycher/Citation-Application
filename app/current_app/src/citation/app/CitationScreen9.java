...
class CitationScreen9 extends MainScreen {
    ...
    CitationScreen9(Citation _c) {
        ...
        if (c.Violation.getElement(CViolation.ACCIDENT).equals("true") ||
            c.Violation.getElement(CViolation.RADAR).equals("true") ||
            c.Violation.getElement(CViolation.JAIL_BOOKING).equals("true") ||
            c.Violation.getElement(CViolation.PACED).equals("true") ||
            c.Violation.getElement(CViolation.SCHOOL_ZONE).equals("true") ||
            c.Violation.getElement(CViolation.ALCOHOL).equals("true"))
        ...
        if (c.Violation.getElement(CViolation.INTENTIONAL).equals("true") ||
            c.Violation.getElement(CViolation.KNOWING).equals("true") ||
            c.Violation.getElement(CViolation.RECKLESS).equals("true") ||
            c.Violation.getElement(CViolation.CRIMINAL_NEG).equals("true") ||
            c.Violation.getElement(CViolation.CULPABLE).equals("true"))
        ...
        if (!c.Violation.getElement(CViolation.CULPABLE).equals("false")) {
            add(new RichTextField("--> No Culpable Mental State"));
        }
    ...
    public class ButtonListener9 implements FieldChangeListener {
        ...
        public void fieldChanged(Field field, int context) {
            ...
            } else if (btn.getLabel().toString() == "Re-Print"
