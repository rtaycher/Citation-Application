...
class CitationScreen1 extends MainScreen {
    ...
    public CitationScreen1(Citation _c){
        ...
        lf1.setBackgroundColor(Color.BLUE);
    ...
    private MenuItem createNew = new MenuItem("New", 110, 10) {
        public void run() {
             ...
             UiApplication.getUiApplication().popScreen(cs1);
             												//---------------NEW CITATION
    ...
    private MenuItem delPrev = new MenuItem("Delete", 110, 11) {
        public void run() {
        	if(CitationStore.List.isEmpty())
        	{
	            ...
	            int index = list.getSelectedIndex();
	            CitationStore.removeCitationByIndex(index); 
	            UiApplication.getUiApplication().popScreen(cs1);
	            UiApplication.getUiApplication().pushScreen(new CitationScreen1(null));
...
final class TestListCallback implements ListFieldCallback {
    ...
    public void drawListRow(ListField list, Graphics g, int index, int y, int w) {
        ...
        g.drawText("Citation # " + _controller.Number, 0, y, DrawStyle.LEFT, w);
    }
