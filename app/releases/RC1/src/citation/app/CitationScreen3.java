...
/**
 * Class: CitationScreen3
 * Description: This class contains methods that will implement the GPS lookup functionality 
 * as well as populate other data fields.
 */
class CitationScreen3 extends MainScreen {
    ...
    CitationScreen3(Citation _c) {    
      ...
      LabelField lf1 = new LabelField("********* TIME & PLACE INFORMATION *********", LabelField.ELLIPSIS | LabelField.USE_ALL_WIDTH | DrawStyle.HCENTER)
        {
            protected void paintBackground(net.rim.device.api.ui.Graphics g) 
            { 
                g.clear(); 
        ...
        Font font1 = fontFamily1[1].getFont(FontFamily.CBTF_FONT, 14); 
        lf1.setFont(font0);              
        add(lf1); 
    ...
    static final class GPSButtonListener3 implements FieldChangeListener {
        ...
        public void fieldChanged(Field field, int context) {
                ...
                if (btn != null) {
                        if (CitationScreen3.currentLocation != null && CitationScreen3.currentLocation.isValid()) {
                                        Status.show("Retrieving GPS Address...");
                                ...
                                {
                                    Dialog.inform("Unable to determine address from GPS location.");
                                }
                        }
                        else {
    ...
    private void storeUIFieldsToCitation()
    {
        ...
        c.Violation.setElement(CViolation.DATE, field_date.toString());
        c.Violation.setElement(CViolation.TIME, field_time.toString());
