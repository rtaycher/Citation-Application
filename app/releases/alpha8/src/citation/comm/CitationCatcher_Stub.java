...
public class CitationCatcher_Stub implements citation.comm.CitationCatcher, javax.xml.rpc.Stub {
        ...
        public java.lang.String getVehicleAsXML(java.lang.String _type, java.lang.String _id, java.lang.String _state) throws java.rmi.RemoteException {
            ...
            inputObject[0] = _type;
            inputObject[1] = _id;
            inputObject[2] = _state;

            Operation op = Operation.newInstance(_qname_getVehicleAsXML, _type_getVehicleAsXML, _type_getVehicleAsXMLResponse);
            _prepOperation(op);
            op.setProperty(Operation.SOAPACTION_URI_PROPERTY, "");
            Object resultObj;
            try {
            ...
            // Convert the result into the right Java type.
            // Unwrapped return value
            Object getVehicleAsXMLReturnObj = ((Object[])resultObj)[0];
            result = (java.lang.String)getVehicleAsXMLReturnObj;
            return result;
        }
        ...
        protected static final QName _qname_license = new QName("http://DefaultNamespace", "_license");
        protected static final QName _qname_vehicle = new QName("http://DefaultNamespace", "_vehicle");
        protected static final QName _qname_vehicle_type = new QName("http://DefaultNamespace", "_vehicle_type");
        protected static final QName _qname_vehicle_plate = new QName("http://DefaultNamespace", "_vehicle_plate");
        protected static final QName _qname_vehicle_state = new QName("http://DefaultNamespace", "_vehicle_state");
        ...
        protected static final QName _qname_getVehicleAsXML = new QName("http://DefaultNamespace", "getVehicleAsXML");
        protected static final QName _qname_getVehicleAsXMLResponse = new QName("http://DefaultNamespace", "getVehicleAsXMLResponse");
        protected static final QName _qname_getVehicleAsXMLReturn = new QName("http://DefaultNamespace", "getVehicleAsXMLReturn");
        ...
        protected static final Element _type_getVehicleAsXML;
        protected static final Element _type_getVehicleAsXMLResponse;
        static {
                ...
                Element _type_license;
                _type_license = new Element(_qname_license, Type.STRING);
                ...
                _complexType_getDMVResultAsXML.elements[0] = _type_license;
                ...
                // Retrieve vehicle information from Type/Plate/State query.
                Element _type_vehicle_type = new Element(_qname_vehicle_type, Type.STRING);
                Element _type_vehicle_plate = new Element(_qname_vehicle_plate, Type.STRING);
                Element _type_vehicle_state = new Element(_qname_vehicle_state, Type.STRING);
                
                ComplexType _complexType_getVehicleAsXML = new ComplexType();
                _complexType_getVehicleAsXML.elements = new Element[3];
                _complexType_getVehicleAsXML.elements[0] = _type_vehicle_type;
                _complexType_getVehicleAsXML.elements[1] = _type_vehicle_plate;
                _complexType_getVehicleAsXML.elements[2] = _type_vehicle_state;
                
                _type_getVehicleAsXML = new Element(_qname_getVehicleAsXML, _complexType_getVehicleAsXML);
                
                Element _type_getVehicleAsXMLReturn = new Element(_qname_getVehicleAsXMLReturn, Type.STRING);
                
                ComplexType _complexType_getVehicleAsXMLResponse = new ComplexType();
                _complexType_getVehicleAsXMLResponse.elements = new Element[1];
                _complexType_getVehicleAsXMLResponse.elements[0] = _type_getVehicleAsXMLReturn;
                
                _type_getVehicleAsXMLResponse = new Element(_qname_getVehicleAsXMLResponse, _complexType_getVehicleAsXMLResponse);
        }
}
