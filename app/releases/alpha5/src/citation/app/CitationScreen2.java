...
public class CitationScreen2 extends MainScreen {
    ...
    private ObjectChoiceField field_state;
    ...
    private ObjectChoiceField field_height;
    ...
    public CitationScreen2(Citation _c) {  
        ...
        field_violations = new NumericChoiceField("Number of Violations: ", 0, 10, 1, 0);
        ...
        field_numOfViol = new ObjectChoiceField("Number of Violations: ", choicestrs10, 0);
        add(field_numOfViol);  
        */
    ...
    private void restoreUIFieldsFromCitation()
    {
                ...
                field_violations.setLabel(c.Person.getElement(CPerson.NUM_OF_VIOLATIONS));
    }    
} 
